...
import { UploadAvatar } from '@/components/preview-components';
...
<ComponentPreview caption="Linear · Notion · Apple ID — circular crop + progress ring">
  <UploadAvatar route="demo" size={96} />
</ComponentPreview>
