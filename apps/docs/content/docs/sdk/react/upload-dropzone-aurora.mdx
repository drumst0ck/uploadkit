...
import { UploadDropzoneAurora } from '@/components/preview-components';
...
<ComponentPreview caption="Apple · Supabase — conic mesh + cursor halo" simulateFiles={3}>
  <UploadDropzoneAurora route="demo" />
</ComponentPreview>
