...
import { UploadButtonMagnetic } from '@/components/preview-components';
...
<ComponentPreview caption="Apple — cursor-attracted spring scale">
  <UploadButtonMagnetic route="demo" />
</ComponentPreview>
