...
[![npm](https://img.shields.io/npm/v/%40uploadkitdev%2Fmcp.svg?color=6366f1)](https://www.npmjs.com/package/@uploadkitdev/mcp) [![Glama score](https://glama.ai/mcp/servers/drumst0ck/uploadkit/badges/score.svg)](https://glama.ai/mcp/servers/drumst0ck/uploadkit) [![Awesome MCP Servers](https://img.shields.io/badge/Mentioned%20in-Awesome%20MCP-ff69b4)](https://github.com/punkpeye/awesome-mcp-servers) [![Official MCP Registry](https://img.shields.io/badge/MCP%20Registry-io.github.drumst0ck%2Fuploadkit-6366f1)](https://registry.modelcontextprotocol.io)
...
Documentation, component discovery, and scaffolding require no credentials. To let the MCP generate signed image variants with `transform_image`, launch it with a paid-plan live key in the server environment:

```bash
UPLOADKIT_API_KEY=uk_live_... npx -y @uploadkitdev/mcp
```

The key is read by the local MCP process and is never passed as a tool argument. Image transformations work only for files stored in UploadKit Cloud, not BYOS.
