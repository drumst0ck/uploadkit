...
We handle the presigned URL, the progress, the retry logic, the rate limiting, the auth, the multipart, and the dark mode. Check the [components page](https://docs.uploadkit.dev/docs/sdk/react) for what's available.
