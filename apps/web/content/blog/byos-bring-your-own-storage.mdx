...
If you want to try BYOS without writing the signing layer yourself, [UploadKit's components](https://docs.uploadkit.dev/docs/sdk/react) work in either mode out of the box. Connect a bucket, ship the dropzone, move on to the next problem.
