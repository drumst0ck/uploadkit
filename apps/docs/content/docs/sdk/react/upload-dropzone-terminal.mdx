...
import { UploadDropzoneTerminal } from '@/components/preview-components';
...
<ComponentPreview caption="Raycast · Warp — mono prompt + tail log" simulateFiles={3}>
  <UploadDropzoneTerminal route="demo" />
</ComponentPreview>
