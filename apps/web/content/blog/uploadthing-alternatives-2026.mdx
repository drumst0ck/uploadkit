...
2. **Components designed by humans who care.** Every component in [`/components`](/components) has dark mode, focus-visible rings, reduced-motion variants, and a real design system underneath — not Tailwind defaults with a border-radius bump.
