...
import { UploadDropzoneBrutal } from '@/components/preview-components';
...
<ComponentPreview caption="Neobrutalism — thick borders + hard shadow" simulateFiles={3}>
  <UploadDropzoneBrutal route="demo" />
</ComponentPreview>
