...
import { UploadInlineChat } from '@/components/preview-components';
...
<ComponentPreview caption="ChatGPT · Linear — composer with animated chips">
  <div style={{ width: 420 }}>
    <UploadInlineChat route="demo" placeholder="Message UploadKit…" />
  </div>
</ComponentPreview>
