...
UploadKit defaults to R2 for managed mode for this exact reason, and supports any S3-compatible bucket via [BYOS](https://docs.uploadkit.dev/docs/sdk/react). The bytes are yours; the bill should be too.
